...
import { Inmueble, initialInmueble, InmuebleForm } from "@/types/inmuebles";
      ...
      <form onSubmit={handleSubmit(onSubmit, onError)} className="p-3">
        ...
        <details className="details-base">
          ...
          <fieldset className="fieldset-base flex flex-col gap-2">
            ...
            <FormField control={control} name="description" label="Descripcion" rules={{ required: "Este campo es obligatorio" }} component={TextArea} />
        ...
        <div className="fixed flex items-center gap-2 right-5 bottom-5 z-30">
          ...
          <p className="p-2 text-sm rounded-full order-1 transition-all ease-in duration-100 text-blue-400 bg-blue-100 border-2 border-blue-200 opacity-0 peer-hover:opacity-100">Enviar inmueble</p>
        </div>
      </form>
    </div>
  )
